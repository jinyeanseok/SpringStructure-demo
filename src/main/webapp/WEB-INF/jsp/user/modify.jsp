		...
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form name="loginForm" method="post" autocomplete="off">
					<div class="form-group">
						...
						<div class="form-label-group">
							<input type="text" id="identification" name="identification"
								...
								value="${UserVO.identification}" readonly required="required"
					...
					<button class="btn btn-primary btn-block" value="modify"
						type="submit">Change Password</button>
					<!-- <input type="button" value="SUBMIT" onclick="toJson_submit()"> -->
				</form>
				<div class="text-center">
					<a class="d-block small mt-3" href="/sample/register">Register
