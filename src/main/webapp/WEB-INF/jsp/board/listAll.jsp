...
<title>jys - Dashboard - Dashboard</title>
...
<body id="page-top">
	...
	<a class="navbar-brand mr-1" href="/board/listAll">Start Bootstrap</a>
			...
			<div class="dropdown-menu dropdown-menu-right"
				...
				<c:if test="${user != null }">
					...
					<c:if test="${user.verify == 9}">
						<a class="dropdown-item" href="/admin/listAll">admin</a>
					</c:if>
				</c:if>
	...
	<div id="wrapper">
		...
		<ul class="sidebar navbar-nav">
			<li class="nav-item active"><a class="nav-link"
				href="/board/listAll"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span>
			</a></li>
							...
							<table class="table table-bordered" id="dataTable" width="100%"
								...
								<c:forEach items="${list}" var="boardVO">
									<tr>
										...
										<td><a
											href="/board/read?board_number=${boardVO.board_number}">${boardVO.title}</a></td>
